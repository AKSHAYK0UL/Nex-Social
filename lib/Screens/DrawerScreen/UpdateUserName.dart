...
class UpdateUserName extends StatefulWidget {
  static const routeName = 'UpdateUserName';
...
class _UpdateUserNameState extends State<UpdateUserName> {
  ...
  Future<void> updateuserName() async {
    ...
    try {
      await Provider.of<AuthFunction>(context, listen: false).updateuserName(
          _currentPasswordController.text, _newUserNameController.text);
    } catch (_) {
      setState(() {
        _wrongPassword = true;
      });
